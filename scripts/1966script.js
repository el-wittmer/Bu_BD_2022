...
svg.append("circle").attr("cx",10).attr("cy",120).attr("r", 6).style("fill", "#a569bd").style("stroke", "black");
svg.append("circle").attr("cx",10).attr("cy",140).attr("r", 6).style("fill", "pink").style("stroke", "black");
svg.append("circle").attr("cx",10).attr("cy",160).attr("r", 6).style("fill", "lightblue").style("stroke", "black");
svg.append("circle").attr("cx",10).attr("cy",180).attr("r", 6).style("fill", "gray").style("stroke", "black");
svg.append("circle").attr("cx",10).attr("cy",200).attr("r", 6).style("fill", "white").style("stroke", "black");
...
svg.append("text").attr("x", 20).attr("y", 125).text("Body Fat").style("font-size", "15px");
svg.append("text").attr("x", 20).attr("y", 145).text("Physical Activity").style("font-size", "15px");
svg.append("text").attr("x", 20).attr("y", 165).text("Psychosocial Factors").style("font-size", "15px");
svg.append("text").attr("x", 20).attr("y", 185).text("Smoking").style("font-size", "15px");
svg.append("text").attr("x", 20).attr("y", 205).text("Undefined").style("font-size", "15px");

async function init() {

    const data = await d3.json('https://raw.githubusercontent.com/el-wittmer/Paul_1963/main/data/Paul_1966.json');
